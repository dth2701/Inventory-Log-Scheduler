...
public class TextUITester {
     ...
     * reads a String, a double, and a character from System.in, and then 3) prints out the string
     * followed by a number that is one greater than that double, if the character that it read in was
     * a (lower case) 'q'.
     */
